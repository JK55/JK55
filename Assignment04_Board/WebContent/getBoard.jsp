...
<%
	...
	// GetBoard 서블릿이 board라는 이름으로 request에 담아놓고 현재 페이지로 이동했으므로
	// request에는 board라는 이름으로 사용할 데이터가 저장되어 있다
...
<body>
	<center>
		<h3>글 상세</h3>
		<h3>${sessionScope.name }님 로그인 환영합니다...... <a
		...
		<a href="addBoard.jsp">글등록</a>&nbsp;&nbsp;&nbsp; <a
			href="deleteBoard?seq=${board.seq }">글삭제</a>&nbsp;&nbsp;&nbsp;
